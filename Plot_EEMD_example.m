...
tr_EAC = NRSPHB_trends.EEMD_trend_EAC(1,:);
...
set(gca,'LineWidth',2,'Box','On','FontSize',18,'YLim',[-3.5 5],'XLim',[datenum(1950,01,01) datenum(2021,01,01)],...
...
leg = legend([p1 p4 p5 p3b p4b],'De-seasoned temperatures', ...
    'Significant EEMD \itT_{\rmR}','Significant EEMD \itT_{\rmR+IMF}','Boundary of insignificance \itT_{\rmR+IMF}','Boundary of insignificance \itT_{\rmR}');
...
leg = legend([p2 p4 p5 p6],'\itIMFs','\itIMF_{Last}','\itT_{R}','\itT_{R+IMF}');
